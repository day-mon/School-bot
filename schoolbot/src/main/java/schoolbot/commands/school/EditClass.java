...
public class EditClass extends Command {
    ...
    public void run(MessageReceivedEvent event, String[] args) {
        ...
        if (SchoolBot.classes.containsKey(args[0])
                && SchoolBot.classes.get(args[0]).getSchool() == SchoolBot.schools.get(args[1])
                && SchoolBot.schools.get(args[1]).getGuild() == event.getGuild()) {
            Classroom classToEdit = SchoolBot.classes.get(0);
            ...
            switch (args[2]) {
                ...
                case "credits":
                    ...
                    if (numeric) {
                        SchoolBot.classes.get(args[0]).setYear(args[3]);
                ...
                case "professor":
                    ...
                    if (SchoolBot.professors.containsKey(args[3])) {
                        Professor prof = SchoolBot.professors.get(args[3]);
