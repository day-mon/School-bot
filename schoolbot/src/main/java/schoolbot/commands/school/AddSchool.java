...
public class AddSchool extends Command {
    ...
    public void run(MessageReceivedEvent event, String[] args) {
        ...
        //TODO: fix usage "look below for correct usage"
            if (args.length != 3) {
                MessageOperations.invalidUsageShortner("https://github.com/tykoooo/School-bot/blob/master/schoolbot/src/main/java/schoolbot/commands/school/AddSchool.java", "Incorrect usage: **Look below for correct usage", event.getMessage(), this);
            } else if (validName) { 
                ...
                MessageOperations.invalidUsageShortner("https://github.com/tykoooo/School-bot/blob/master/schoolbot/src/main/java/schoolbot/commands/school/AddSchool.java", "This is not a valid school", event.getMessage(), this);
            }
    }
